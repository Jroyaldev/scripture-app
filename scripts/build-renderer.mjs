...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self'; img-src 'self' data:; connect-src 'self'; media-src 'self' https://nakedbiblepodcast.com https://afp-597195-injected.calisto.simplecastaudio.com https://traffic.megaphone.fm https://*.megaphone.fm">
