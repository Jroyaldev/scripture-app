...
test("research drill and branch actions have a deliberate primary-secondary hierarchy", () => {
  // These two are handles inside the Living Margin, which gives up mono
  // entirely: serif for content, Instrument Sans for handles. Their
  // primary/secondary hierarchy is carried by size and ink, not by voice.
